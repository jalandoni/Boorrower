<template>
  <v-card class="my-4 mx-auto px-10 pb-10" max-width="35%" elevation="5">
    <v-form ref="form" v-model="valid" :lazy-validation="lazy">
      ...
      <v-row>
         <v-col cols="12" md="9">
              <h3 class="mb-15">Personal Information</h3>
              </v-col>
        <v-col cols="12" md="8">
          <v-text-field v-model="firstname" @keypress="onlyLetter" :rules="nameRules" placeholder="Input Letter" label="First name" required></v-text-field>
        </v-col>
        <v-col cols="12" md="8">
          <v-text-field v-model="lastname"  @keypress="onlyLetter" :rules="nameRules" placeholder="Input Letter"  label="Last name" required></v-text-field>
        </v-col>
        <v-col cols="12" md="8">
